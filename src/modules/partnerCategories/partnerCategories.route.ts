...
import * as partnersCtrl from "./partnerCategories.controller.js";
import {
  createPartnersSchema,
  updatePartnersSchema,
} from "./partnerCategories.schema.js";
import { validate } from "../../middlewares/validate.js";
import { uploadMiddleware } from "../../middlewares/multer-s3.middleware.js";

const router = Router();

const uploaded = uploadMiddleware("partners").none();
...
export { router as PartnerCategoriesRoutes };
